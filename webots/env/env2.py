...
def is_place(x,y,object1,object2):
    ...
    if (x > -0.365 and x < -0.141 and y < 0.65 and y > 0.475):
        return False

        # fix3
    if (x > -0.267 and x < 0.062 and y < 0.156 and y > -0.180):
        return False

        # fix1
    if (x > 0.261 and x < 0.725 and y < 0.347 and y > -0.03):
        return False

        # fix2
    if (x > -0.42 and x < -0.08 and y < -0.473 and y > -0.65):
        return False


    if (x > 0.65 or x < -0.65 or y < -0.65 or y > 0.65):
        return False
...
def wall_detection(x,y):
    ...
    if ( x > -0.345 and x < -0.161 and y < 0.68 and y > 0.495 ):
        return True

    #fix3
    if (x > -0.247 and x < 0.042 and y < 0.136 and y > -0.160):
        return True

    # fix1
    if (x > 0.281 and x < 0.705 and y < 0.327 and y > 0.01):
        return True

    # fix2
    if (x > -0.4 and x < -0.1 and y < -0.493 and y > -0.68):
        return True

    if(x>0.68 or x<-0.68 or y>0.68 or y<-0.68):
        return True
    else:
        return False
...
class env():
    def __init__(self, seed, Max_step):
        ...
        self.box.append(self.robot.getFromDef("box5"))
        self.box.append(self.robot.getFromDef("box6"))
        self.ball=[]
    ...
    def set_car_target(self):
        ...
        for i in range(6):
            x = random.random() * 1.3 - 0.65
            y = random.random() * 1.3 - 0.65
